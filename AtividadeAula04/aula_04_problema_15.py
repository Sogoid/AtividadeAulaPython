...
while __cont__ <= 4:
    ...
    print(f"******* Informe os dados do funcionário {__cont__} ********\n")
    ...
    print(f"*** Contra-Cheque dos dados do funcionário {__cont__} ***\n")
    ...
    print(
        f"Valor da Hora  => R$ {valorHora:_>10}\n"
    ...
    print(f"*** Informações adicionais do Contra-Cheque {__cont__} ***\n")
